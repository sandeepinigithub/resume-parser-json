...
module.exports = {
  titles: {
    ...
    education: ['education', 'knowledge and qualifications', 'knowledge & qualifications', 'person specification'],
    skills: ['skills', 'Skills & Expertise', 'technology', 'technologies', 'Skills and Experience'],
    languages: ['languages'],
    courses: ['courses'],
    projects: ['projects'],
    links: ['links'],
    ...
    awards: ['awards'],
    honors: ['honors'],
    additional: ['additional', 'aptitudes'],
